...
var svgJarRepoUrl = 'https://github.com/ivanvotti/ember-svg-jar';
...
function assetsToViewerModel(assets, hasManyStrategies) {
  ...
  var links = [{ text: 'Contribute', url: svgJarRepoUrl }, { text: 'About', url: svgJarRepoUrl + '/blob/master/README.md' }];
